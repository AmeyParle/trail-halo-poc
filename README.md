...
and the signature checking is genuine Ed25519/JCS, not a mock. Raw tool arguments
never enter the record — `halo-record` stores a hash plus a redacted summary.
